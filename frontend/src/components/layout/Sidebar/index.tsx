// Sidebar Component - Crisis Command & Recovery Navigation
        ...
        <div className="flex items-center justify-center h-16 border-b border-gray-200 dark:border-gray-700">
          {sidebarCollapsed ? (
            ...
            <div className="text-center">
              <span className="text-xl font-bold text-primary-600">FinTwin AI</span>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Crisis Command</p>
            </div>
          )}
        </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          {!sidebarCollapsed && (
            <div className="text-xs text-gray-500 dark:text-gray-400 text-center">
              <p className="font-semibold">Crisis Platform v1.0</p>
              <p className="mt-1">© 2026 FinTwin AI</p>
            </div>
          )}
        </div>
      </div>
