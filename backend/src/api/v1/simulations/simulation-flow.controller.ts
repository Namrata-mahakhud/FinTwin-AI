...
export class SimulationFlowController {
   ...
   */
  validateScenario = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
   ...
   */
  generatePreview = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
    const { id } = request.params as { id: string };
    const userId = (request as any).user.id;
   ...
   */
  applyRecovery = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
    const { id } = request.params as { id: string };
    const userId = (request as any).user.id;
   ...
   */
  getHistory = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
    const userId = (request as any).user.id;
   ...
   */
  replaySimulation = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
    const { id } = request.params as { id: string };
    const userId = (request as any).user.id;
   ...
   */
  compareSimulations = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
   ...
   */
  exportSimulation = asyncHandler(async (request: FastifyRequest, reply: FastifyReply) => {
    const { id } = request.params as { id: string };
    const userId = (request as any).user.id;
